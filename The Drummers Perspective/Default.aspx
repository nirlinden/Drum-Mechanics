...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container text-center pt-5 pb-5">
        <h1 class="main-title text-uppercase">DRUM<br>MECHANICS</h1>
        
        <div class="mt-3 mb-4">
            <span class="main-subtitle">Explaining Progressive Metal</span>
        </div>
    </div>
    ...
    <div class="container pb-5 text-center cards-container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-4">
                <div class="card rounded" style="background-image: url('Images/card-peart.jpg');">
            ...
            <div class="col-md-4">
                <div class="card rounded" style="background-image: url('Images/card-lombardo.jpg');">
                    <div class="card-content text-start">
            ...
            <div class="col-md-4">
                <div class="card rounded" style="background-image: url('Images/card-portnoy.jpg');">
                    <div class="card-content text-start">
